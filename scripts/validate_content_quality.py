...
shapes. Those questions belong to renovation-analysis-workflow / PUBLISH_REVIEW.
"""
...
def main() -> None:
    ...
    if not bodies:
        raise SystemExit("No active content/<route>/body.html files found")
    ...
    print(
        "NOTE: machine validation does not replace renovation-analysis-workflow / "
